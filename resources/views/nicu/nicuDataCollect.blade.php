    ...
    <div class='row'>        
        <div class="col-lg-8 col-md-12 col-sm-12">
            <div class="panel panel-success">
                <div class="panel-heading text-center"><strong><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Coleta de Dados Uti Neonatal</strong></div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/nicuInsertData">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control text-center" id="deathsLess1500" name="deathsLess1500" required value='@if(isset($insertResult) && $insertResult !== "Sucesso" && isset($request->deathsLess1500)){{ $request->deathsLess1500 }}@else{{""}}@endif'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-7" for="dischargesLess1500">Número de Saídas RN < 1500gr</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control text-center" id="dischargesLess1500" name="dischargesLess1500" required value='@if(isset($insertResult) && $insertResult !== "Sucesso" && isset($request->dischargesLess1500)){{ $request->dischargesLess1500 }}@else{{""}}@endif'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-7" for="deathsBetween1500And2500">Número de Óbitos RN &#8805 1500gr e &#60 2500gr</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control text-center" id="deathsBetween1500And2500" name="deathsBetween1500And2500" required value='@if(isset($insertResult) && $insertResult !== "Sucesso" && isset($request->deathsBetween1500And2500)){{ $request->deathsBetween1500And2500 }}@else{{""}}@endif'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-7" for="deathsHigher2500">Número de Óbitos RN &#8805 2500gr</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control text-center" id="deathsHigher2500" name="deathsHigher2500" required value='@if(isset($insertResult) && $insertResult !== "Sucesso" && isset($request->deathsHigher2500)){{ $request->deathsHigher2500 }}@else{{""}}@endif'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-7" for="dischargesBetween1500And2500">Número de Saídas RN &#8805 1500gr e &#60 2500gr</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control text-center" id="dischargesBetween1500And2500" name="dischargesBetween1500And2500" required value='@if(isset($insertResult) && $insertResult !== "Sucesso" && isset($request->dischargesBetween1500And2500)){{ $request->dischargesBetween1500And2500 }}@else{{""}}@endif'>
                            </div>
                        </div>
                        <div class="form-group">
