            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="{{ url('/nicuIndicators') }}" title="Indicadores Uti Neonatal">
                            <i class="fa fa-bar-chart" aria-hidden="true"></i>
                        </a>
                        <a class="navbar-brand" href="{{ url('/nicuDataCollect') }}" title="Coleta de Dados Uti Neonatal">
                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </a>
                        <a class="navbar-brand" href="{{ url('/nicuTable') }}" title="Visualizar a tabela com os dados preenchidos">
