                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="?id={{ $resultado->i_id }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="radio-inline">
                                    <label><input type="radio" name="optradiolocal" value="Hospital Unimed" @if(isset($resultado->local_internacao) && $resultado->local_internacao == "Hospital Unimed"){{ 'checked' }} @else {{ "" }}@endif>Hospital Unimed</label>
                                </div>
                                <div class="radio-inline">
                                ...
                                <div class="radio-inline">
                                    <label><input data-toggle="collapse" data-target="#outroLocal" type="radio" name="optradiolocal" Value="Outros" @if(isset($resultado->local_internacao) && $resultado->local_internacao == 'Hospital Unimed' || $resultado->local_internacao == 'Santa Casa'){{ "" }}@else{{ 'checked' }}@endif>Outros</label>
                                </div>  
                            </div>
                        </div>
                        
                        @if(isset($resultado->local_internacao) && $resultado->local_internacao == 'Hospital Unimed' || $resultado->local_internacao == 'Santa Casa')
                        <div class="form-group collapse" id="outroLocal">
                            <label class="control-label col-sm-3" for="outroLocal">Local:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="outroLocal" value="@if(isset($resultado->local_internacao) && $resultado->local_internacao == 'Hospital Unimed' || $resultado->local_internacao == 'Santa Casa'){{ "" }}@else{{ $resultado->local_internacao }}@endif">
                            </div>
                        </div>
                        @else 
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                ...
                                <a type="button" class="btn btn-success" href="/tabelaInternacoes">Voltar</a>                                
                            </div>
                        </div>
                    </form>
                </div>            
