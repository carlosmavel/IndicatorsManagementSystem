                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="?">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="nomePaciente" placeholder="Nome Completo do Paciente" value='@if(isset($resultadoProcessar) && $resultadoProcessar !== "Sucesso" && isset($request->nomePaciente)){{ $request->nomePaciente }}@else{{""}}@endif'>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="radio-inline">
                                    <label><input type="radio" name="optradiolocal" value="Hospital Unimed" onclick="teste" @if(isset($resultadoProcessar) && $resultadoProcessar !== "Sucesso" && isset($request->optradiolocal) && $request->optradiolocal == "Hospital Unimed"){{ 'checked' }} @else {{ "" }}@endif>Hospital Unimed</label>
                                </div>
                                <div class="radio-inline">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                ...
                                <a type="button" class="btn btn-success" href="/tabelaInternacoes">Ver Tabela</a>                                
                            </div>
                        </div>
                    </form>
                </div>            
